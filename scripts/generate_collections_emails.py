...
def build_email(customer: str, group: pd.DataFrame,
    ...
    # ── ESCALATION ────────────────────────────────────────────────────────
        ...
        body = (
            f"Hello,\n"
            f"\n"
            f"We're following up regarding an outstanding balance on your account "
            f"that remains past due. We'd appreciate your prompt attention to the "
            f"invoices listed below.{upcoming_note}\n"
            f"\n"
            f"{invoice_block}"
            f"\n{balance_line}\n"
            f"\n"
            f"Please remit payment or contact us today to discuss next steps. "
            f"We value your business and look forward to resolving this promptly.\n"
            f"\n"
            f"Thank you,\n"
            f"Working Solutions Inc.\n"
        )
...
def build_email_html(customer: str, group: pd.DataFrame,
    ...
    # ── ESCALATION ───────────────────────────────────────────────────────
        ...
        html_body = (
            f"<p>Hello,</p>"
            f"<p>We're following up regarding an outstanding balance on your account "
            f"that remains past due. We'd appreciate your prompt attention to the "
            f"invoices listed below.{upcoming_note}</p>"
            f"{invoice_block_html}"
            f"{balance_line_html}"
            f"<p>Please remit payment or contact us today to discuss next steps. "
            f"We value your business and look forward to resolving this promptly.</p>"
            f"<p>Thank you,<br>Working Solutions Inc.</p>"
        )
